...
// Vercel Edge Config overrides price, group deal and the switches at runtime
// (see lib/config.js). To reuse this app for another event: change this file,
// swap the copy/assets under app/ + public/, point the env vars at new
// Supabase/Resend/payment accounts.
export const EVENT = {
    name: 'coppi',
    date: '2026-08-22',
    ticketPrefix: 'CO-',
    ...
    maxPrice: 60,            // > minPrice → sliding scale; = minPrice → one fixed price
    priceStep: 5,            // € between the sliding-scale steps
    maxQuantity: 10,         // tickets per order
    groupDeal: { size: 4, pay: 3 }, // e.g. 4 tickets for the price of 3; null → off
    sounds: true,            // click sounds on buttons
    currency: 'eur',
