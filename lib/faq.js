export const FAQ_ITEMS = [
    ...
    {
        q: 'Who is playing?',
        a: 'Annyrock b2b Degen, CRYME, David Fogarty, DJ Fart in the Club, Jana Falcon, Lara Fein, nd_baumecker. Deep and driving, warm and a little hypnotic, with moments that pull you somewhere further out and back again. Some of it will creep up on you slow, some of it won\'t.',
    },
    {
        q: 'What\'s the idea behind this?',
        a: 'Honestly, we got a bit tired of the Berlin club circuit. Same venues, same routines, same everything. We wanted something that felt more like the old days: good music, a proper soundsystem, friends and strangers mixing naturally, actually being present.',
    },
    {
        q: 'What about the music?',
        a: 'We are bringing out the Loud Professional soundsystem. The idea is simple: music that makes a sunny day with friends and a cold Sekt feel exactly right. Whether you are deep in the dancefloor or just lying in the grass, it should sound good.',
    },
    {
    ...
    {
        q: 'Can I volunteer?',
        a: 'Yes! We need a few people to help us run things. In return you get a free ticket and the good feeling of supporting a cool project.',
