...
// Sold-out mode, currently switched off (see below).
export async function isSoldOut() {
    // ponytail: sales are open again — the Edge Config / SOLD_OUT flag is ignored
    // on purpose. Restore the body below to switch sold-out mode back on.
    return false;
}
