export const NEWSLETTERS = {
    '1': {
        ...
        content: [
            ...
            { type: 'text', text: 'Make sure to share with your friends, the ones you\'d want beside you as the sun comes up. Tickets are available now, grab yours early so we can plan accordingly. And one tip: there are a few group tickets available if you want to save some money and come with your crew.' },
        ],
    },
};
