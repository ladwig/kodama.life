export const NEWSLETTERS = {
    '1': {
        ...
        content: [
            ...
            { type: 'text', text: 'sidequest is an all day/all night open air gathering being held in Berlin. You\'ll find yourself among beautiful pine, oak and linden trees. A little slice of nature not so far from the chaos of the city.' },
    ...
    '4': {
        ...
        showTicket: true,
        content: [
            { type: 'heading', text: 'A Sidequest for sidequest' },
            { type: 'text', italic: true, segments: [
                { text: 'Quests rarely go as planned.' },
                { br: true },
                { text: 'And sidequests are almost entirely unplanned.' },
                { br: true },
                { text: 'For sidequest, unfortunately this seems to have held true.' },
            ]},
            { type: 'text', text: 'We promised a gathering amongst the trees, to join the monsters on their journey, to dance, to share, to conspire. The winds of fortune were blowing elsewhere and ultimately the clipboard brigade decided otherwise.' },
            { type: 'text', text: "We're pulling up the stakes, rearranging the pieces and heading for a new patch. Not quite as planned but hoping to bring the same sentiment to our new location." },
            { type: 'text', segments: [
                { text: 'Before we packed it all up, ' },
                { text: 'here is what we built out there', href: '/gallery' },
                { text: ' — a small window into the gathering amongst the trees.' },
            ]},

            { type: 'heading', text: 'What this all means' },
            { type: 'callout', title: 'New location and time', segments: [
                { text: 'sidequest will move to Kreuzwerk, starting outdoor and moving indoors.', bold: true },
                { br: true },
                { text: 'Starting a little later than planned at ' },
                { text: '16:00', bold: true },
                { text: ' and running through until the morning.' },
            ]},
            { type: 'text', text: 'The lineup remains the same.' },
            { type: 'text', text: 'More tickets will be available online and at the door.' },
            { type: 'text', segments: [
                { text: 'If you want to contact us regarding your ticket, or have any questions, please contact us at ' },
                { text: 'booking@kodama.life', href: 'mailto:booking@kodama.life' },
                { text: '.' },
            ]},
        ],
    },
