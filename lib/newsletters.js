export const NEWSLETTERS = {
    ...
    '3': {
        date: '20.08.2026',
        // Goes to ticketholders — they're already subscribed
        hideSignup: true,
        content: [
            ...
            { type: 'callout', title: 'No tickets at the door', text: "There won't be any tickets at the door. Please do not come if you don't have one already — it's not worth the trip." },
            { type: 'heading', text: 'Getting there and back' },
            { type: 'text', text: "Public transport to BER Airport, then follow the ‘Fahrradweg’ signs — a few minutes by bike, or about 35 minutes on foot. By taxi or Uber, get dropped at the marked pick-up point (the roundabout) and walk the last 10 minutes." },
            { type: 'callout', title: 'Taxis, Ubers and cars', segments: [
                { text: 'Driving a car on the bike lane is prohibited — use the ' },
            ...
            { type: 'text', segments: [
                ...
                { text: '. The path is uneven in places, so it\'s not step-free throughout — get in touch beforehand if you need support.' },
            ]},
            ...
            { type: 'text', text: "sidequest is a private event. No membership (aka ticket) bought in advance, no entry. A ticket doesn't guarantee entry; we reserve the right to refuse at the door." },
